...
content = Frame(root)
ori_img = Label(content, image=blank_img, bg="#856ff8")
grayscale_img = Label(content, image=blank_img)
hsv_img = Label(content, image=blank_img)
ori_img_label = Label(content, text="Original Image", bg="#856ff8")
grayscale_img_label = Label(content, text="Grayscale Image")
glcm_img_label = Label(content, text="GLCM Image")
hsv_img_label = Label(content, text="HSV Image")
contrast_label = Label(content, text="Contrast", bg="red")
dissimilarity_label = Label(content, text="Dissimilarity", bg="red")
homogeneity_label = Label(content, text="Homogeneity", bg="red")
energy_label = Label(content, text="Energy", bg="red")
correlation_label = Label(content, text="Correlation", bg="red")
asm_label = Label(content, text="ASM", bg="red")
angle_0_label = Label(content, text="0", width=30, bg="red")
angle_45_label = Label(content, text="45", width=30, bg="red")
angle_90_label = Label(content, text="90", width=30, bg="red")
angle_135_label = Label(content, text="135", width=30, bg="red")
contrast_0_label = Label(content, textvariable=contrast_0)
contrast_45_label = Label(content, textvariable=contrast_45)
contrast_90_label = Label(content, textvariable=contrast_90)
contrast_135_label = Label(content, textvariable=contrast_135)
dissimilarity_0_label = Label(content, textvariable=dissimilarity_0)
dissimilarity_45_label = Label(content, textvariable=dissimilarity_45)
dissimilarity_90_label = Label(content, textvariable=dissimilarity_90)
dissimilarity_135_label = Label(content, textvariable=dissimilarity_135)
homogeneity_0_label = Label(content, textvariable=homogeneity_0)
homogeneity_45_label = Label(content, textvariable=homogeneity_45)
homogeneity_90_label = Label(content, textvariable=homogeneity_90)
homogeneity_135_label = Label(content, textvariable=homogeneity_135)
energy_0_label = Label(content, textvariable=energy_0)
energy_45_label = Label(content, textvariable=energy_45)
energy_90_label = Label(content, textvariable=energy_90)
energy_135_label = Label(content, textvariable=energy_135)
correlation_0_label = Label(content, textvariable=correlation_0)
correlation_45_label = Label(content, textvariable=correlation_45)
correlation_90_label = Label(content, textvariable=correlation_90)
correlation_135_label = Label(content, textvariable=correlation_135)
asm_0_label = Label(content, textvariable=asm_0)
asm_45_label = Label(content, textvariable=asm_45)
asm_90_label = Label(content, textvariable=asm_90)
asm_135_label = Label(content, textvariable=asm_135)
...
select_img_button = Button(content, text="Select Image", command=select_image)
feature_extraction_button = Button(content, text="Feature Extraction", command=feature_extraction)

content.grid(column=0, row=0, sticky=(N, W, E, S))
ori_img.grid(column=1, row=0, rowspan=3, sticky=(N, W, E, S))
grayscale_img.grid(column=1, row=4, rowspan=6)
hsv_img.grid(column=1, row=11, rowspan=3)
ori_img_label.grid(column=1, row=3, sticky=(N,W,E,S))
...
contrast_label.grid(column=2, row=5, sticky=(N,W,E,S))
dissimilarity_label.grid(column=2, row=6, sticky=(N,W,E,S))
homogeneity_label.grid(column=2, row=7, sticky=(N,W,E,S))
energy_label.grid(column=2, row=8, sticky=(N,W,E,S))
correlation_label.grid(column=2, row=9, sticky=(N,W,E,S))
asm_label.grid(column=2, row=10, sticky=(N,W,E,S))
